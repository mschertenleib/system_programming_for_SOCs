...
void task3_main()
{
    ...
    printf("Task 3: dcache misses: %10lld\n", perf_read_counter(PERF_COUNTER_0));
    printf("Task 3: stall cycles: %10lld\n", perf_read_counter(PERF_COUNTER_1));
    printf("Task 3: bus idle cycles: %10lld\n", perf_read_counter(PERF_COUNTER_2));
    printf("Task 3: icache misses: %10lld\n", perf_read_counter(PERF_COUNTER_3));
    printf("Task 3: runtime cycles: %10lld\n", perf_read_counter(PERF_COUNTER_RUNTIME));

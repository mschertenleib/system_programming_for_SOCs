...
int main() {
   ...
   perf_print_cycles(PERF_COUNTER_2, "Instruction Cache Fetch cycles");
   perf_print_cycles(PERF_COUNTER_3, "Instruction Cache Miss cycles");
   ...
   perf_print_time(PERF_COUNTER_2, "Instruction Cache Fetch time");
   perf_print_time(PERF_COUNTER_3, "Instruction Cache Miss time");
   perf_print_time(PERF_COUNTER_RUNTIME, "Runtime time  ");
   dcache_flush();
#endif
}
